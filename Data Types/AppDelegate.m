...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /*
    NSLog(@"boolVar = %ld, intVar = %ld, uIntVar = %ld, floatVar = %ld, doubleVar = %ld", sizeof(boolVar), sizeof(intVar), sizeof(uIntVar), sizeof(uIntVar), sizeof(floatVar), sizeof(doubleVar));
    */
    ...
    /*
    MDStudent* studentA = [[MDStudent alloc] init];
    
    studentA.name = @"Best Student";
    
    NSLog(@"StudentA name = %@",studentA.name );
    
    MDStudent* studentB =studentA;
...
*/
   ...
   [student setGender:MDGenderMale];
    */
